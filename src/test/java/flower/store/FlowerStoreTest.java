...
public class FlowerStoreTest {
    ...
    public void testFlowerCopyConstructorCreatesIndependentObject() {
        ...
        Assertions.assertNotEquals(original.getPrice(), copy.getPrice(), "Price change should not affect original");
        Assertions.assertNotEquals(original.getSepalLength(), copy.getSepalLength(), "Sepal length change should not affect original");
        Assertions.assertNotEquals(original.getColor(), copy.getColor(), "Color change should not affect original");
    }
    ...
    public void testFlowerPackGetPrice() {
        Assertions.assertEquals(roseRed.getPrice() * 50, rosePack.getPrice());
    }
    ...
    public void testBucketSearchScoreHigherForRelevant() {
        ...
        Assertions.assertTrue(score1 > score2, "Bucket with matching tulip should have higher score");
    }
    ...
    public void testSearchResultCountLimit() {
        ...
        Assertions.assertEquals(1, results.size(), "Search with count limit should return exactly 1 result");
    }
    ...
    public void testSearchPerfectMatchRanksFirst() {
        ...
        Assertions.assertEquals(bucket1, results.get(0), "Bucket1 should be first because it has exact tulip match");
    }
    ...
    public void testSearchExactChamomileMatchRanksFirst() {
        ...
        Assertions.assertEquals(bucket2, topBucket, "Bucket2 (contains chamomile pack) should be top for chamomile search");
    ...
    public void testSearchExactRoseMatchRanksFirst() {
        ...
        Assertions.assertEquals(bucket1, top, "Bucket1 should rank first because it contains red roses");
